...
The default full API config currently runs:
...
OpenRouter previously returned `400 Bad Request` for `bytedance-seed/seed-2.0-pro`. To run the active non-Doubao model set:
